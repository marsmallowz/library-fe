...
export default function ModalUpdateBook({
  isVisible,
  closeModal,
  book,
  setChange,
  ...
  return (
    <div
      ...
      className="fixed inset-0 z-50 flex flex-col items-center justify-center bg-black bg-opacity-30 py-12">
      <div
        className={`flex flex-col h-4/6 w-1/2 rounded-2xl  border-4 bg-orange-400 border-black shadow-[15px_15px]`}>
